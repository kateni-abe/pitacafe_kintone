(function () {
  ...
  function tagView(setInfo, buttons) {
    ...
    const fieldsForB = ['法人管理番号', '法人名', '法人担当者名', 'コース', '更新月','案件一覧'];
    const fieldsForC = ['法人管理番号', '法人名', '法人担当者名', 'コース', '更新月','コミュニケーション履歴'];
    const fieldsForD = ['法人管理番号', '法人名', '法人担当者名', 'コース', '更新月','Field_trip_インターン_申込数・参加者数', '研修会・勉強会など_企画参加実績', '貸切利用_利用日'];
    const fieldsForE = ['法人管理番号', '法人名', '法人担当者名', 'コース', '更新月','請求書'];
    const fieldsForF = ['法人管理番号', '法人名', '法人担当者名', 'コース', '更新月','財務関連', '財務諸表', '財務諸表_2'];
    const fieldsForG = ['法人管理番号', '法人名', '法人担当者名', 'コース', '更新月','法人担当者情報'];
    const fieldsForH = ['法人管理番号', '法人名', '法人担当者名', 'コース', '更新月','関連園情報'];
